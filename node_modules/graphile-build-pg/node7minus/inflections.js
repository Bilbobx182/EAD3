...
var newInflector = exports.newInflector = function newInflector() {
  ...
  return (0, _assign2.default)({
    ...
    updateByKeysInputType(detailedKeys, name, _schema) {
      ...
      return upperCamelCase(`update-${singularizeTable(name)}-by-${detailedKeys.map(function (key) {
    ...
    deleteByKeysInputType(detailedKeys, name, _schema) {
      ...
      return upperCamelCase(`delete-${singularizeTable(name)}-by-${detailedKeys.map(function (key) {
